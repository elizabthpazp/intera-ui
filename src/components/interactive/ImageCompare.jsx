...
export default function ImageCompare({
  ...
  return (
    <div
      ...
      className={cn(
        "relative overflow-hidden rounded-2xl select-none group touch-none shadow-lg isolate",
        darkMode ? "bg-black ring-1 ring-white/10" : "bg-white ring-1 ring-black/[0.06]",
        className
      )}
