...
export default function GlassStack({
  ...
  return (
    <div className={cn("relative w-full h-[320px] sm:h-[400px] flex items-center justify-center perspective-1000", className)} style={style}>
          ...
          {items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "absolute inset-0 rounded-3xl p-6 border flex flex-col justify-between backdrop-blur-xl transition-colors",
                  darkMode 
              ...
              >
                <div className="space-y-2">
                  <div className={cn("w-10 h-1 rounded-full", darkMode ? "bg-gray-700" : "bg-gray-200")} />
                  <h3 className="text-xl font-bold leading-tight">{item.title}</h3>
                </div>

                <p className={cn("text-sm leading-relaxed", darkMode ? "text-gray-400" : "text-gray-600")}>
                  {item.content}
                </p>
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className={cn("w-8 h-8 rounded-full flex items-center justify-center border", darkMode ? "border-gray-700 bg-gray-800" : "border-gray-100 bg-white")}>
                    →
                  </div>
                </div>
              </motion.div>
      ...
      <div className={cn("absolute bottom-4 text-[10px] font-bold uppercase tracking-[0.2em] opacity-40", darkMode ? "text-white" : "text-black")}>
